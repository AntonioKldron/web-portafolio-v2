// src/frontend/data/herramientas/herramientasData.jsx
// Refactored: categories array is shared; only title text varies per lang.
...
// Fixed — category icons and items are the same regardless of language
...
// Only labels change per language
