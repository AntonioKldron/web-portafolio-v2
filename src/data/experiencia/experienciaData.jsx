...
const baseData = {
  ...
  EXP_01: {
    ...
    proyectos: [ 
      ...
      { tecnologias: [dt.sql, dt.sqlserver, dt.json, dt.api], repositorio: "/404" },
      { tecnologias: [dt.sql, dt.sqlserver, dt.djangorest, dt.django, dt.python, dt.api, dt.json, dt.docker, dt.linux], repositorio: "/404" },
      { tecnologias: [dt.sql, dt.sqlserver, dt.djangorest, dt.django, dt.python, dt.api, dt.json, dt.intelisis, dt.docker, dt.linux], repositorio: "/404" },
      { tecnologias: [dt.sql, dt.sqlserver, dt.json, dt.api], repositorio: "/404" },
      { tecnologias: [dt.sql, dt.sqlserver, dt.json, dt.api, dt.intelisis], repositorio: "/404" },
