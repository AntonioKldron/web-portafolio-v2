export const ProfileFooter = ({ socials, cv }) => (
  <footer className="pt-8 border-t border-main-border space-y-8 relative z-10">
    <div className="flex items-center justify-between">
      ...
      <a href={cv} download className="group relative px-6 py-2.5 bg-main-bg border border-main-border rounded-xl text-[10px] font-black tracking-widest text-main-text uppercase overflow-hidden hover:bg-primary-accent hover:text-white transition-all duration-500 shadow-sm">
