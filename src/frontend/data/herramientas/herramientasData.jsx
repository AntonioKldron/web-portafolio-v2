...
export const herramientasData = {
  ...
  es: {
    ...
    categorias: [
      ...
      { id: "cat-5", title: "Bases de Datos", items: [dt.sqlserver, dt.oracle, dt.postgresql, dt.mysql, dt.supabase, dt.firebase] },
  ...
  en: {
    ...
    categorias: [
      ...
      { id: "cat-3", title: "Frontend", items: [dt.html, dt.css, dt.astro, dt.react, dt.tailwind, dt.bootstrap] },
      { id: "cat-4", title: "ERP Solutions", items: [dt.peoplesoft, dt.intelisis] },
      { id: "cat-5", title: "Databases", items: [dt.sqlserver, dt.oracle, dt.postgresql, dt.mysql, dt.supabase, dt.firebase] },
